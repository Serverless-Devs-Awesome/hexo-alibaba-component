...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
var HexoComponent = /** @class */ (function (_super) {
    __extends(HexoComponent, _super);
    function HexoComponent(id) {
        return _super.call(this, id) || this;
    }
    HexoComponent.prototype.deploy = function (inputs) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, Detail, frameworkInputs, formatStr;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        frameworkInputs.Bootstrap = format(bootstrap_1.DEFAULTBOOTSTRAP, formatStr);
                        return [4 /*yield*/, _super.prototype.deploy.call(this, frameworkInputs)];
                    case 1: return [2 /*return*/, _b.sent()];
                }
            });
        });
    };
    HexoComponent.prototype.remove = function (inputs) {
        return __awaiter(this, void 0, void 0, function () {
